...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference("Articulo.count") do
      post articulos_url, params: { articulo: { fecha_ingreso: @articulo.fecha_ingreso, marca: @articulo.marca, modelo: @articulo.modelo, portador_id: @articulo.portador_id } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { fecha_ingreso: @articulo.fecha_ingreso, marca: @articulo.marca, modelo: @articulo.modelo, portador_id: @articulo.portador_id } }
